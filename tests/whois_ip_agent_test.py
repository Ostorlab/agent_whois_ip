...
def testAgentWhoisIP_whenDnsRecordMsgRecieved_emitsWhoisRecords(
    scan_message_dns_resolver_record, test_agent, agent_mock, agent_persist_mock
):
...
def testAgentWhoisIP_whenDnsAAAAMsgRecieved_emitsWhoisRecords(
    scan_message_dns_aaaa_record, test_agent, agent_mock, agent_persist_mock
):
...
def testAgentWhoisIP_whenIPv4WithMaskTarget_returnsWhoisRecord(
    scan_message_ipv4_mask,
    scan_message_ipv4_mask_2,
    test_agent,
    agent_mock,
    agent_persist_mock,
):
